...
<template>
    <div>
        <button v-if="as == 'button'" type="submit" class="block w-full px-4 py-2 text-sm leading-5 text-gray-700 text-left bg-white hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition" style="border:none">
            <slot />
        </button>
