                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <NavLink :href="route('widget.admin.dashboard')" :active="route().current('dashboard')">
                                    首頁
                                </NavLink>
                                <NavLink :href="route('widget.admin.polls.index')" >
                                    投票
                                </NavLink>
                                <NavLink :href="route('widget.admin.materials')" >
                                    教材
                                </NavLink>
                                <NavLink :href="route('widget.admin.tutorials')" >
                                    教學
                                </NavLink>
                            </div>
                        </div>
