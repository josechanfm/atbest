                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <NavLink :href="route('manage.dashboard')" v-if="$page.props.auth.user.roles.includes('admin')">
                                    Admin
                                </NavLink>
                            </div>
                        </div>
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            ...
                            <div class="ml-3 relative">
                                <Dropdown align="right" width="48">
                                    <template #trigger>
                                        <button v-if="$page.props.auth.user.member && $page.props.auth.user.member.avatar" class="flex text-sm border-2 border-transparent rounded-full focus:outline-none focus:border-gray-300 transition">
                                            <img class="h-8 w-8 rounded-full object-cover" :src="$page.props.auth.user.member.avatar" :alt="$page.props.auth.user.name">
                                        </button>
